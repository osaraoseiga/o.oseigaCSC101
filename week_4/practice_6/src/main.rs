fn main() {
    ...
    println!("\nThe {} is infprmed by the aspiration to train electrical/electronic engineering proffesionals in the areas of design, building and maintenance of Electricalcontrol systems,",n4 );
